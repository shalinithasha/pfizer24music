...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/shalinithasha/pfizer24music)

### Deploy to VPS

```sh
git clone https://github.com/shalinithasha/pfizer24music
cd VCMusicPlayer
...
4. `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://replit.com/@ThashaKwela/Pfizer24music)
...
## License
```sh
Pfizer Music Player, Telegram Voice Chat Userbot
...
- [Shalini](https://github.com/shalinithasha/pfizer24music) [Dev]
